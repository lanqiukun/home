...
<body>
    ...
    <article class="page-container">
        ...
        <form action="{{ route('admin.houseowner.create') }}" method="post" class="form form-horizontal" id="form-member-add">
            @csrf
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="number" class="input-text" autocomplete="off" value="{{ old('age') }}" placeholder="" id="age" name="age">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" class="input-text" autocomplete="on" value="{{ old('phone') }}" placeholder="" id="phone" name="phone">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" class="input-text" autocomplete="off" value="{{ old('card') }}" placeholder="" id="card" name="card">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" class="input-text" autocomplete="off" value="{{ old('address') }}" placeholder="" id="address" name="address">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6" id="app">
                    <el-upload class="avatar-uploader" action="{{ route('admin.houseowner.houseowner_pic') }}" name="houseowner_pic" :show-file-list="false" :on-success="handleAvatarSuccess" :headers="headers" :before-upload="beforeAvatarUpload">
