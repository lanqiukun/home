...
<body>
    ...
    <article class="page-container">
        ...
        <form action="{{ route('admin.article.update', $article->id) }}" method="post" class="form form-horizontal" id="form-member-add">
            @csrf

            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>标题：</label>
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" class="input-text" autocomplete="off" value="{{ $article->title }}" placeholder="" id="title" name="title">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" class="input-text" autocomplete="off" value="{{ $article->desc }}" placeholder="" id="desc" name="desc">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <img src="{{ $article->cover }}" id="default_cover" class="radius" alt="响应式图片" style="max-width: 300px">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    ...
                    <input type="hidden" value="{{ $article->cover }}" id="cover" name="cover">
